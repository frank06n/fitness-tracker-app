    ...
    _renderDropdown() {
        ...
        return (
            <FlatList
                ...
                data={filteredOptions == undefined ? options : filteredOptions}
                ...
                ListHeaderComponent={dropdownListProps ? dropdownListProps.ListHeaderComponent : this._renderSearchInput}
